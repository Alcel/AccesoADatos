	  ...
	  String DRIVER = "org.hsqldb.jdbcDriver";
		String CONECTOR = "jdbc:hsqldb:file:src/db/consultorio.Hsqldb";
			...
			try {
				...
				ResultSet respuesta = sentencia.executeQuery("SELECT * FROM Doctores");
...
public static void telefonos() {
	...
	try {
		...
		// Preparar la consulta
		Statement sentencia = conexion.createStatement();
		ResultSet respuesta = sentencia.executeQuery("SELECT * FROM Pacientes Where Nombre like '%a'");

		// Recorremos la respuesta para visualizar cada fila
		while (respuesta.next()) {
			System.out.println(respuesta.getString("Nombre")+" "+respuesta.getString("Tfno"));
		}
